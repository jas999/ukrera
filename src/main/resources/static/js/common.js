...
function deloptdv(stk){
	...
	if($(stk).parent().parent().attr('id') == 'member-dls-dv'){
		
		
		 var frm= $(".delField");
		 if(frm.attr('action')=="updateCompanyPromoterDetails"){
			 frm.attr("action", "updateCompanyPromoterDetailsWoMemberDetails");
		 }
		 else{
			 frm.attr("action", "saveCompanyPromoterDetailsWoMemberDetails");
		 }
		 }
