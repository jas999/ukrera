...
function saveOrUpdateProjectDetailsForm() {
	console.log("inside project jsBkp  saveorupdateprojectdeatialsform 22222");
...
function saveOrUpdateProjectDetailsForm() {
	...
	//}
	console.log("inside project jsBkp  saveorupdateprojectdeatialsform");
	$("#trxForm").submit();
}
